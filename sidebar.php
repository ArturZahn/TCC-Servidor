...
function barrinhaverde($urlItemMenu)
{
    if($urlItemMenu == $GLOBALS["url"])
    {
        echo '<span class="absolute inset-y-0 left-0 w-1 bg-verdecoopaf-600 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>';
    }
}
