...
function linha($linhas, $templateColunas)
{

  foreach ($linhas as $keycolunas => $colunas)
  {
    echo '<tr class="text-gray-700 dark:text-gray-400">';
  
    foreach ($colunas as $keycoluna => $coluna)
    {
      // var_dump($templateColunas[$keycoluna][0]);
      // echo "<br>";
      // echo "<br>";
      // echo "<br>";
      // echo "<br>";
      echo "<td class='px-4 py-3'>";
      echo $templateColunas[$keycoluna][0];
      echo $coluna;
      echo $templateColunas[$keycoluna][1];
      echo "</td>";
    }
...
function tabela($titulo, $nomecolunas, $linas, $templateColunas)
{
              ...
              <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                        <?php
                            foreach ($nomecolunas as $keynomecolunas => $nomecolunas) {
                                # code...
                  ...
                  >
                          <?php linha($linas, $templateColunas); ?>
                  </tbody>
                </table>
              </div>
              <div
