      ...
      <div class="flex flex-col flex-1">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          ...
          <div class="container px-6 mx-auto grid">
            ...
            <a class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple" href="produtor_adicionar.php">
            ...
            <?php
                ...
                tabela(array(
                  ...
                  "templateColunas" => array(
                    ...
                    function($exibe){return "<span>$exibe[produtor_email]</span>";},

                    function($exibe){return "<span>$exibe[produtor_telefone]</span>";},

                    function($exibe){return "<span>$exibe[produtor_cpfcnpj]</span>";},

                    function($exibe){
                      $cod = $exibe['produtor_cod'];
                      return "
                      <div class='flex items-center space-x-4 text-sm'>
                      <a href='produtor_editar.php'>
