<?php
    ...
    else $sqlQuery = "SELECT produto_nome, produto_cod, produto_preco, produto_foto, produtor_nome FROM produto JOIN produtor USING(produtor_cod) ORDER BY RAND() ASC";
