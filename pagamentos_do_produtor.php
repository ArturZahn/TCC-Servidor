        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <?php
                ...
                echo "<span class='text-gray-700 dark:text-gray-400'>Número total de pagamentos: $e1[num]</span><br>";
                ...
                // altere esses dados ↓↓↓
                $itensPorPag = 15;
                $queryDados       = "SELECT SUM(produto_preco*itempedido_quantidade) AS precoItem, pagamento_data FROM itempedido JOIN produto USING(produto_cod) JOIN itempagamento USING(itempedido_cod) JOIN pagamento USING(pagamento_cod) WHERE produtor_cod = $cod_produtor GROUP BY pagamento_cod LIMIT $itensPorPag OFFSET ".($numDaPag-1)*$itensPorPag;
