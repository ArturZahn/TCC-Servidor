...
// JOIN itempagamento USING(pagamento_cod)
// JOIN itempedido USING(itempedido_cod);
// JOIN produto USING(produto_cod);

// SELECT *, COUNT(pagamento_cod) FROM pagamento
// JOIN itempagamento USING(pagamento_cod)
// JOIN itempedido USING(itempedido_cod)
// JOIN produto USING(produto_cod)
// WHERE produtor_cod = 1;
