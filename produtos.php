      ...
      <div class="flex flex-col flex-1">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          ...
          <div class="container px-6 mx-auto grid">
            ...
            <a class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple" href="produtos_adicionar.php">
              ...
              <?php
                ...
                // altere esses dados ↓↓↓
                $itensPorPag = 10;
                $queryDados       = "SELECT produto_cod, produto_nome, produto_quantidadeemestoque, produto_preco from produto limit $itensPorPag offset ".($numDaPag-1)*$itensPorPag;
                ...
                tabela(array(
                  ...
                  "templateColunas" => array(
                    ...
                    function($exibe){return "<span>$exibe[produto_quantidadeemestoque]</span>";},
                    ...
                    function($exibe){
                      $cod = $exibe['produto_cod'];
                      return "
                      <div class='flex items-center space-x-4 text-sm'>
                      <a href='produtos_editar.php'>
